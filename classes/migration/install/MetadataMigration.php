    ...
    public function up(): void
    {
        ...
        Schema::create('citations', function (Blueprint $table) {
            ...
            $table->foreign('publication_id', 'citations_publication')
                ->references('publication_id')->on('publications')->cascadeOnDelete();
        ...
        Schema::create('citation_settings', function (Blueprint $table) {
            ...
            $table->foreign('citation_id', 'citation_settings_citation_id')
                ->references('citation_id')->on('citations')->cascadeOnDelete();
