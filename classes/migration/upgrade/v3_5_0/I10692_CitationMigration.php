 ...
 */
//todo decide what to do with existing citations: structure all or none.
...
class I10692_CitationMigration extends Migration
{
    ...
    {
        $this->migrateRawCitationsToCitationSettings();

        $this->deleteRawCitationsFromPublications();
     ...
     */
    public function migrateRawCitationsToCitationSettings(): void
    {
    ...
    /**
     * Delete rawCitations setting in publication_settings.
     */
    public function deleteRawCitationsFromPublications(): void
    {
        DB::table('publication_settings')
            ->where('setting_name', 'rawCitations')
            ->delete();
    }
}
