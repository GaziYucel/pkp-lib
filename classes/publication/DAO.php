...
class DAO extends EntityDAO
{
    ...
    public function fromRow(object $row): Publication
    {
        ...
        $this->setCitationsRaw($publication);
        $this->setCitations($publication);
    ...
    /**
     * Set a publication's citationsRaw property.
     */
    protected function setCitationsRaw(Publication $publication): void
    {
        $publication->setData(
            'citationsRaw',
    ...
    /**
     * Set a publication's citations property.
     */
    protected function setCitations(Publication $publication): void
    {
        $publication->setData(
            'citations',
            Repo::citation()
